...
OUTPUT_PATH=merged_data_batch_corrected_2_batches_n_5.csv
...
INPUT_PATH=merged_data.csv
BATCH_LABELS=("first" "second")
OUTPUT_PATH=merged_data_batch_corrected_3_batches_n_5.csv
...
# 3.a) 2 batches
INPUT_PATH=merged_data_batch_corrected_2_batches_n_5.csv
OUTPUT_PATH=preprocessed_patch_snRNA_counts_2_batches_n_5.csv
...
# 3.b) 3 batches
INPUT_PATH=merged_data_batch_corrected_3_batches_n_5.csv
OUTPUT_PATH=preprocessed_patch_snRNA_counts_3_batches_n_5.csv
